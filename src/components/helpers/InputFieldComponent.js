		...
		if (this.props.inputType === "text") {
			...
			return (
				<FieldWraper>
					...
					<select defaultValue="Selecione..." onChange={this.props.onChange}>
			...
			return (
				<FieldWraper>
					<label htmlFor={this.props.name} > {this.props.fieldName} </label>
					<input id={this.props.name} name={this.props.name} type="number" min="0" max="99999" value={this.props.value} onChange={this.props.onChange} />
				</FieldWraper>
			);
			...
			return (
				<FieldWraper>
					<label htmlFor={this.props.name} > {this.props.fieldName} </label>
					<input id={this.props.name} name={this.props.name} type="date" min="0" max="99999" value={this.props.value} onChange={this.props.onChange} />
				</FieldWraper>
			);
		}
	}
